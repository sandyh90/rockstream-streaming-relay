<div class="text-center mb-0">
    ...
    <h5 class="fw-light">RockStream V1.0.3</h5>
</div>
<ul class="d-grid gap-4 my-5 list-unstyled">
    ...
    <li class="d-flex gap-4">
        ...
        <div>
            ...
            For now this app design only for windows and maybe not working properly if use outside windows
            platform.
        </div>
    </li>
</ul>
...
<ul>
    ...
    <li><span class="bi bi-cpu fs-4 me-1"></span>Processor Min. Dual Core with speed clock 2.40 GHz or
        High (Except For Premiere Video Transcoding).</li>
    <li><span class="bi bi-device-hdd fs-4 me-1"></span>Storage free space capacity Min. 1-4 GB or more (Due to live
        session start the HLS footage will capture temporary for the preview player or you can disable live preview in
        interfaces settings).</li>
    <li><span class="bi bi-gpu-card fs-4 me-1"></span>Use
        external / dedicated graphics card for best performance (Optional: For Premiere Video Transcoding).</li>
</ul>
...
<ul>
    <li><span class="bi bi-plus-slash-minus fs-4 me-1"></span>Due nginx service built for windows
        version and some feature may not work like in linux version.
    </li>
    <li><span class="bi bi-question-square fs-4 me-1"></span>Status RTMP in navbar reseting to
        ...
        for now only support in linux version. <a href="https://github.com/arut/nginx-patches" target="_blank">[Nginx
            Patches Source]</a></li>
...
<hr>
<div class="fw-light fs-5">Acknowledgements</div>
<ul>
    <li><a href="https://nginx.org/" target="_blank">Nginx</a></li>
    <li><a href="https://github.com/arut/nginx-rtmp-module" target="_blank">nginx-rtmp-module</a></li>
    <li><a href="https://www.electronjs.org/" target="_blank">Electron</a></li>
    <li><a href="https://www.laravel.com/" target="_blank">Laravel Framework</a></li>
