...
<link rel="stylesheet" href="{{ asset('assets/vendor/zoomify/zoomify.min.css') }}">
...
<div class="container">
    <div class="row">
        @if(AppInterfaces::getsetting('USE_LIVE_PREVIEW') == TRUE)
        ...
        <div class="col-xl-6 mb-4 mx-auto">
            <div class="card card-body text-center">
                ...
                <div class="control-action-stream-btn">
                    ...
                    <button class="btn btn-primary control-stream-btn my-2" control-stream-action="restart"><span
                            class="bi bi-arrow-clockwise me-1"></span>Restart Server
                    </button>
                    <button class="btn btn-secondary control-stream-btn my-2" control-stream-action="regenerate"><span
                ...
                <div class="card card-body">
                    ...
                    <div class="encoder-setting-data">
                        <div class="fetch-datastream-encoder-info"></div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function fetch_stream_key() {
            $.ajax({
                ...
                async: true,
                beforeSend: function() {
                    $("div.fetch-datastream-encoder-info").append('<div class="text-center my-2"><div class="spinner-border spinner-border-sm"></div><span class="ms-1">Fetching Data Stream Encoder</span></div>');
                },
                success: function(data) {
                    $("div.fetch-datastream-encoder-info").empty();
...
<script>
    ...
    if (typeof Hls != 'undefined') {
        ...
        const player = new Plyr(video, {
            controls: ['play', 'mute', 'volume','settings', 'pip', 'airplay', 'fullscreen'],
            storage: {enabled: false, key: 'rockstream-player'},
            autoplay: true,
            muted: true,
            ratio: '16:9'
        });
        ...
        // Handle error when video stream is not available or broken and show offline preview or restart stream.
