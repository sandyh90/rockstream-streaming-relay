...
class PanelController extends Controller
{
    ...
    public function get_stat_rtmp()
    {
        ...
        try {
            ...
            return response()->json(['success' => FALSE, 'msg' => 'Get rtmp stat failed.'], 200);
        }
    }
    ...
    public function check_stream_preview(Request $request)
    {
        ...
        if (!empty($stream_db)) {
            $hls_preview_path = config('app.url') . ':' . config('component.nginx_port_rtmp') . "/{$stream_db->key_input_stream}/index.m3u8";
            try {
